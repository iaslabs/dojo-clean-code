...
public class Store {
    ...
    public Store(String nombre, String direccion, DescontadorDeZone descontadorDeZone, DefinicionRepositorio algunRepositorio) {
        this.nombre = nombre;
        this.direccion = direccion;
        this.descontadorDeZone = descontadorDeZone;
        this.algunRepositorio = algunRepositorio;
    }
